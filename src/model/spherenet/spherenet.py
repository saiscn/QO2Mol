...
class update_v(torch.nn.Module):
    ...
    def forward(self, e, i, num_nodes):
        _, e2 = e
        # qq: fix bug, in case that radius_graph's return i not fulfill the node indices
